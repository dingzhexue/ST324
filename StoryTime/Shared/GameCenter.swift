...
//  StoryTime
//
//  Created by 123 on 12/18/17.
//

import GameKit

/// Custom delegate used to provide information to the application implementing GameCenter.
public protocol GameCenterDelegate: class {
...
/// A GameCenter instance represents a wrapper around a GameKit match.
public class GameCenter: NSObject, GKMatchmakerViewControllerDelegate, GKGameCenterControllerDelegate, GKMatchDelegate, GKLocalPlayerListener {
    ...
    /// The shared instance of GameCenter, allowing you to access the same instance across all uses of the library.
    public class var sharedInstance: GameCenter {
        struct Static {
    ...
    override init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(GameCenter.authenticationChanged), name: Notification.Name.GKPlayerAuthenticationDidChangeNotificationName, object: nil)
    }
    ...
    /**
     ...
     :param: delegate The delegate receiving data from GameCenter.
     */
    public func findMatchWithMinPlayers(_ minPlayers: Int, maxPlayers: Int, viewController: UIViewController, delegate theDelegate: GameCenterDelegate) {
        matchStarted = false
        match = nil
